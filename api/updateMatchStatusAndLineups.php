...
// Ενεργοποίηση λαθών για να τα βλέπουμε στο Logcat αν κάτι πάει στραβά
...
try {
    ...
    // ΠΡΟΣΟΧΗ: Τα ονόματα εδώ πρέπει να είναι ΟΛΟΪΔΙΑ με το @Field του ApiService
    $home = $_POST['home_starters'] ?? [];
    $away = $_POST['away_starters'] ?? [];
