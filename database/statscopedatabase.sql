...
-- Χρόνος δημιουργίας: 15 Ιουν 2026 στις 21:08:48
...
--
-- Βάση δεδομένων: `statscopedatabase`
--
...
(5, 'SuperLeague', '2026-06-15 18:54:18');
...
(87, 2, 1, 3, 2, 2, 1, 'live'),
(183, 5, 12, 1, 1, 0, 0, 'scheduled'),
(184, 5, 1, 12, 14, 0, 0, 'scheduled'),
(185, 5, 13, 9, 1, 0, 0, 'scheduled'),
(186, 5, 9, 13, 14, 0, 0, 'scheduled'),
(187, 5, 4, 3, 1, 0, 0, 'scheduled'),
(188, 5, 3, 4, 14, 0, 0, 'scheduled'),
(189, 5, 5, 8, 1, 0, 0, 'scheduled'),
(190, 5, 8, 5, 14, 0, 0, 'scheduled'),
(191, 5, 10, 2, 1, 0, 0, 'scheduled'),
(192, 5, 2, 10, 14, 0, 0, 'scheduled'),
(193, 5, 11, 7, 1, 0, 0, 'scheduled'),
(194, 5, 7, 11, 14, 0, 0, 'scheduled'),
(195, 5, 6, 14, 1, 0, 0, 'scheduled'),
(196, 5, 14, 6, 14, 0, 0, 'scheduled'),
(197, 5, 12, 9, 2, 0, 0, 'scheduled'),
(198, 5, 9, 12, 15, 0, 0, 'scheduled'),
(199, 5, 1, 3, 2, 0, 0, 'scheduled'),
(200, 5, 3, 1, 15, 0, 0, 'scheduled'),
(201, 5, 13, 8, 2, 0, 0, 'scheduled'),
(202, 5, 8, 13, 15, 0, 0, 'scheduled'),
(203, 5, 4, 2, 2, 0, 0, 'scheduled'),
(204, 5, 2, 4, 15, 0, 0, 'scheduled'),
(205, 5, 5, 7, 2, 0, 0, 'scheduled'),
(206, 5, 7, 5, 15, 0, 0, 'scheduled'),
(207, 5, 10, 14, 2, 0, 0, 'scheduled'),
(208, 5, 14, 10, 15, 0, 0, 'scheduled'),
(209, 5, 11, 6, 2, 0, 0, 'scheduled'),
(210, 5, 6, 11, 15, 0, 0, 'scheduled'),
(211, 5, 12, 3, 3, 0, 0, 'scheduled'),
(212, 5, 3, 12, 16, 0, 0, 'scheduled'),
(213, 5, 9, 8, 3, 0, 0, 'scheduled'),
(214, 5, 8, 9, 16, 0, 0, 'scheduled'),
(215, 5, 1, 2, 3, 0, 0, 'scheduled'),
(216, 5, 2, 1, 16, 0, 0, 'scheduled'),
(217, 5, 13, 7, 3, 0, 0, 'scheduled'),
(218, 5, 7, 13, 16, 0, 0, 'scheduled'),
(219, 5, 4, 14, 3, 0, 0, 'scheduled'),
(220, 5, 14, 4, 16, 0, 0, 'scheduled'),
(221, 5, 5, 6, 3, 0, 0, 'scheduled'),
(222, 5, 6, 5, 16, 0, 0, 'scheduled'),
(223, 5, 10, 11, 3, 0, 0, 'scheduled'),
(224, 5, 11, 10, 16, 0, 0, 'scheduled'),
(225, 5, 12, 8, 4, 0, 0, 'scheduled'),
(226, 5, 8, 12, 17, 0, 0, 'scheduled'),
(227, 5, 3, 2, 4, 0, 0, 'scheduled'),
(228, 5, 2, 3, 17, 0, 0, 'scheduled'),
(229, 5, 9, 7, 4, 0, 0, 'scheduled'),
(230, 5, 7, 9, 17, 0, 0, 'scheduled'),
(231, 5, 1, 14, 4, 0, 0, 'scheduled'),
(232, 5, 14, 1, 17, 0, 0, 'scheduled'),
(233, 5, 13, 6, 4, 0, 0, 'scheduled'),
(234, 5, 6, 13, 17, 0, 0, 'scheduled'),
(235, 5, 4, 11, 4, 0, 0, 'scheduled'),
(236, 5, 11, 4, 17, 0, 0, 'scheduled'),
(237, 5, 5, 10, 4, 0, 0, 'scheduled'),
(238, 5, 10, 5, 17, 0, 0, 'scheduled'),
(239, 5, 12, 2, 5, 0, 0, 'scheduled'),
(240, 5, 2, 12, 18, 0, 0, 'scheduled'),
(241, 5, 8, 7, 5, 0, 0, 'scheduled'),
(242, 5, 7, 8, 18, 0, 0, 'scheduled'),
(243, 5, 3, 14, 5, 0, 0, 'scheduled'),
(244, 5, 14, 3, 18, 0, 0, 'scheduled'),
(245, 5, 9, 6, 5, 0, 0, 'scheduled'),
(246, 5, 6, 9, 18, 0, 0, 'scheduled'),
(247, 5, 1, 11, 5, 0, 0, 'scheduled'),
(248, 5, 11, 1, 18, 0, 0, 'scheduled'),
(249, 5, 13, 10, 5, 0, 0, 'scheduled'),
(250, 5, 10, 13, 18, 0, 0, 'scheduled'),
(251, 5, 4, 5, 5, 0, 0, 'scheduled'),
(252, 5, 5, 4, 18, 0, 0, 'scheduled'),
(253, 5, 12, 7, 6, 0, 0, 'scheduled'),
(254, 5, 7, 12, 19, 0, 0, 'scheduled'),
(255, 5, 2, 14, 6, 0, 0, 'scheduled'),
(256, 5, 14, 2, 19, 0, 0, 'scheduled'),
(257, 5, 8, 6, 6, 0, 0, 'scheduled'),
(258, 5, 6, 8, 19, 0, 0, 'scheduled'),
(259, 5, 3, 11, 6, 0, 0, 'scheduled'),
(260, 5, 11, 3, 19, 0, 0, 'scheduled'),
(261, 5, 9, 10, 6, 0, 0, 'scheduled'),
(262, 5, 10, 9, 19, 0, 0, 'scheduled'),
(263, 5, 1, 5, 6, 0, 0, 'scheduled'),
(264, 5, 5, 1, 19, 0, 0, 'scheduled'),
(265, 5, 13, 4, 6, 0, 0, 'scheduled'),
(266, 5, 4, 13, 19, 0, 0, 'scheduled'),
(267, 5, 12, 14, 7, 0, 0, 'scheduled'),
(268, 5, 14, 12, 20, 0, 0, 'scheduled'),
(269, 5, 7, 6, 7, 0, 0, 'scheduled'),
(270, 5, 6, 7, 20, 0, 0, 'scheduled'),
(271, 5, 2, 11, 7, 0, 0, 'scheduled'),
(272, 5, 11, 2, 20, 0, 0, 'scheduled'),
(273, 5, 8, 10, 7, 0, 0, 'scheduled'),
(274, 5, 10, 8, 20, 0, 0, 'scheduled'),
(275, 5, 3, 5, 7, 0, 0, 'scheduled'),
(276, 5, 5, 3, 20, 0, 0, 'scheduled'),
(277, 5, 9, 4, 7, 0, 0, 'scheduled'),
(278, 5, 4, 9, 20, 0, 0, 'scheduled'),
(279, 5, 1, 13, 7, 0, 0, 'scheduled'),
(280, 5, 13, 1, 20, 0, 0, 'scheduled'),
(281, 5, 12, 6, 8, 0, 0, 'scheduled'),
(282, 5, 6, 12, 21, 0, 0, 'scheduled'),
(283, 5, 14, 11, 8, 0, 0, 'scheduled'),
(284, 5, 11, 14, 21, 0, 0, 'scheduled'),
(285, 5, 7, 10, 8, 0, 0, 'scheduled'),
(286, 5, 10, 7, 21, 0, 0, 'scheduled'),
(287, 5, 2, 5, 8, 0, 0, 'scheduled'),
(288, 5, 5, 2, 21, 0, 0, 'scheduled'),
(289, 5, 8, 4, 8, 0, 0, 'scheduled'),
(290, 5, 4, 8, 21, 0, 0, 'scheduled'),
(291, 5, 3, 13, 8, 0, 0, 'scheduled'),
(292, 5, 13, 3, 21, 0, 0, 'scheduled'),
(293, 5, 9, 1, 8, 0, 0, 'scheduled'),
(294, 5, 1, 9, 21, 0, 0, 'scheduled'),
(295, 5, 12, 11, 9, 0, 0, 'scheduled'),
(296, 5, 11, 12, 22, 0, 0, 'scheduled'),
(297, 5, 6, 10, 9, 0, 0, 'scheduled'),
(298, 5, 10, 6, 22, 0, 0, 'scheduled'),
(299, 5, 14, 5, 9, 0, 0, 'scheduled'),
(300, 5, 5, 14, 22, 0, 0, 'scheduled'),
(301, 5, 7, 4, 9, 0, 0, 'scheduled'),
(302, 5, 4, 7, 22, 0, 0, 'scheduled'),
(303, 5, 2, 13, 9, 0, 0, 'scheduled'),
(304, 5, 13, 2, 22, 0, 0, 'scheduled'),
(305, 5, 8, 1, 9, 0, 0, 'scheduled'),
(306, 5, 1, 8, 22, 0, 0, 'scheduled'),
(307, 5, 3, 9, 9, 0, 0, 'scheduled'),
(308, 5, 9, 3, 22, 0, 0, 'scheduled'),
(309, 5, 12, 10, 10, 0, 0, 'scheduled'),
(310, 5, 10, 12, 23, 0, 0, 'scheduled'),
(311, 5, 11, 5, 10, 0, 0, 'scheduled'),
(312, 5, 5, 11, 23, 0, 0, 'scheduled'),
(313, 5, 6, 4, 10, 0, 0, 'scheduled'),
(314, 5, 4, 6, 23, 0, 0, 'scheduled'),
(315, 5, 14, 13, 10, 0, 0, 'scheduled'),
(316, 5, 13, 14, 23, 0, 0, 'scheduled'),
(317, 5, 7, 1, 10, 0, 0, 'scheduled'),
(318, 5, 1, 7, 23, 0, 0, 'scheduled'),
(319, 5, 2, 9, 10, 0, 0, 'scheduled'),
(320, 5, 9, 2, 23, 0, 0, 'scheduled'),
(321, 5, 8, 3, 10, 0, 0, 'scheduled'),
(322, 5, 3, 8, 23, 0, 0, 'scheduled'),
(323, 5, 12, 5, 11, 0, 0, 'scheduled'),
(324, 5, 5, 12, 24, 0, 0, 'scheduled'),
(325, 5, 10, 4, 11, 0, 0, 'scheduled'),
(326, 5, 4, 10, 24, 0, 0, 'scheduled'),
(327, 5, 11, 13, 11, 0, 0, 'scheduled'),
(328, 5, 13, 11, 24, 0, 0, 'scheduled'),
(329, 5, 6, 1, 11, 0, 0, 'scheduled'),
(330, 5, 1, 6, 24, 0, 0, 'scheduled'),
(331, 5, 14, 9, 11, 0, 0, 'scheduled'),
(332, 5, 9, 14, 24, 0, 0, 'scheduled'),
(333, 5, 7, 3, 11, 0, 0, 'scheduled'),
(334, 5, 3, 7, 24, 0, 0, 'scheduled'),
(335, 5, 2, 8, 11, 0, 0, 'scheduled'),
(336, 5, 8, 2, 24, 0, 0, 'scheduled'),
(337, 5, 12, 4, 12, 0, 0, 'scheduled'),
(338, 5, 4, 12, 25, 0, 0, 'scheduled'),
(339, 5, 5, 13, 12, 0, 0, 'scheduled'),
(340, 5, 13, 5, 25, 0, 0, 'scheduled'),
(341, 5, 10, 1, 12, 0, 0, 'scheduled'),
(342, 5, 1, 10, 25, 0, 0, 'scheduled'),
(343, 5, 11, 9, 12, 0, 0, 'scheduled'),
(344, 5, 9, 11, 25, 0, 0, 'scheduled'),
(345, 5, 6, 3, 12, 0, 0, 'scheduled'),
(346, 5, 3, 6, 25, 0, 0, 'scheduled'),
(347, 5, 14, 8, 12, 0, 0, 'scheduled'),
(348, 5, 8, 14, 25, 0, 0, 'scheduled'),
(349, 5, 7, 2, 12, 0, 0, 'scheduled'),
(350, 5, 2, 7, 25, 0, 0, 'scheduled'),
(351, 5, 12, 13, 13, 0, 0, 'scheduled'),
(352, 5, 13, 12, 26, 0, 0, 'scheduled'),
(353, 5, 4, 1, 13, 0, 0, 'scheduled'),
(354, 5, 1, 4, 26, 0, 0, 'scheduled'),
(355, 5, 5, 9, 13, 0, 0, 'scheduled'),
(356, 5, 9, 5, 26, 0, 0, 'scheduled'),
(357, 5, 10, 3, 13, 0, 0, 'scheduled'),
(358, 5, 3, 10, 26, 0, 0, 'scheduled'),
(359, 5, 11, 8, 13, 0, 0, 'scheduled'),
(360, 5, 8, 11, 26, 0, 0, 'scheduled'),
(361, 5, 6, 2, 13, 0, 0, 'scheduled'),
(362, 5, 2, 6, 26, 0, 0, 'scheduled'),
(363, 5, 14, 7, 13, 0, 0, 'scheduled'),
(364, 5, 7, 14, 26, 0, 0, 'scheduled');
...
(84, 87, 2164, 'shot', 'goal', 90),
(85, 87, 579, 'assist', 'success', 90),
(88, 87, 41130, 'foul_committed', 'success', 27),
(90, 87, 2374, 'foul_committed', 'success', 37),
(91, 87, 2374, 'card_yellow', 'success', 37),
(92, 87, 2374, 'foul_committed', 'success', 79),
(93, 87, 2374, 'card_yellow', 'success', 79),
(97, 87, 42315, 'pass', 'success', 43),
(98, 87, 2164, 'pass', 'failure', 43),
(99, 87, 2722, 'pass', 'success', 43);
...
ALTER TABLE `match_lineups`
  ...
  ADD CONSTRAINT `match_lineups_ibfk_2` FOREIGN KEY (`player_id`) REFERENCES `players` (`id`) ON DELETE CASCADE;
